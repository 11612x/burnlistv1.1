...
const TradeDashboard = () => (
  <div style={{
    ...
    {/* Main Section: Table + Chart/Journal */}
    <div style={{ display: 'flex', gap: 32 }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        {/* Trade Journal */}
        <div style={{ ...boxStyle, minHeight: 120 }}>
          <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 8 }}>Trade Journal</div>
          <div style={{ color: '#888', fontSize: 14, marginBottom: 6 }}>
            <div>⬆️ Entry: 2024-07-10</div>
            <div>🟡 Adjust stop: 2024-07-12</div>
            <div>✅ Exit: 2024-07-14</div>
            <div>📝 Note: "Breakout on volume"</div>
          </div>
          <div style={{ color: '#888', fontSize: 13 }}>Search: <input style={{ background: 'black', color: CRT_GREEN, border: `1px solid ${CRT_GREEN}`, borderRadius: 2, padding: '2px 8px', fontFamily: 'Courier New' }} placeholder="symbol or keyword" /></div>
        </div>
      </div>
    </div>
