...
function TradingViewChart() {
  ...
  return (
    <div className="tradingview-widget-container" style={{height: 140px', width: '100%'}}>
      <div ref={containerRef} className="tradingview-widget-container__widget" style={{height: '120px', width: '100%'}} />
