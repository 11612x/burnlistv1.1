      ...
      <table style={{
        ...
        tableLayout: "fixed"
           ...
           <tr style={{ borderBottom: `2px solid ${CRT_GREEN}` }}>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black' }}>
               {editMode ? (
        <input
          type="checkbox"
        ...
        />
             ...
             <th 
               ...
               style={{ width: "8.33%", padding: "8px", textAlign: "left", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', cursor: "pointer" }}
             >
               Symbol {renderSortArrow("symbol")}
             </th>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>
               Trade Type
             </th>
             <th 
               onClick={() => handleSort("lastPrice")} 
               style={{ width: "8.33%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', cursor: "pointer" }}
             >
               Last Price {renderSortArrow("lastPrice")}
             </th>
             <th style={{ width: "8.33%", padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>SETUP</th>
             <th style={{ width: "8.33%", padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>NEWS</th>
             <th style={{ width: "8.33%", padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>VERDICT</th>
             <th onClick={() => handleSort("entryPrice")} style={{ width: "8.33%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', cursor: "pointer" }}>
               Entry Price {renderSortArrow("entryPrice")}
             </th>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>SL</th>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>TP</th>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>Position</th>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "left", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>Notes</th>
             <th style={{ width: "8.33%", padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>Execute</th>
           ...
           {sortedUniverse.map((item, idx) => (
            ...
            >
              <td style={{ width: "8.33%", padding: "8px", textAlign: "center" }}>
                {editMode ? (
          <input
            type="checkbox"
          ...
          />
              ...
              <td style={{ width: "8.33%", padding: "8px", textAlign: "left" }}>{item.symbol}</td>
              <td style={{ width: "8.33%", padding: "8px", textAlign: "center" }}>
                {editMode ? (
                  <select
              ...
              <td style={{ width: "8.33%", padding: "8px", textAlign: "right" }}>${item.lastPrice.toFixed(2)}</td>
              <td style={{ width: "8.33%", padding: '2px 4px', textAlign: 'center' }}>
              ...
              <td style={{ width: "8.33%", padding: "8px", textAlign: "right" }}>
              ...
              <td style={{ width: "8.33%", padding: "8px", textAlign: "right" }}>
                {item.positionSize ? item.positionSize : '-'}
                            ...
                            <td style={{ width: "8.33%", padding: "8px", textAlign: "left" }}>
                {editMode ? (
