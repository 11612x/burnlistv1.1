...
const HomePage = ({ watchlists = {}, setWatchlists }) => {
  ...
  return (
    <div style={{
      ...
      color: isInverted ? 'black' : CRT_GREEN,
      backgroundColor: isInverted ? CRT_GREEN : 'black',
      minHeight: '100vh',
      padding: '32px',
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <strong style={{ fontSize: '170%', lineHeight: '40px', display: 'inline-block' }}>BURNLIST v1.1</strong>
        </div>
