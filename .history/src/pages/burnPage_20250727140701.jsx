...
import { calculateETFPrice, calculateTWAP } from '../utils/portfolioUtils';
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <strong>ETF Price:</strong> ${etfPriceData.averagePrice.toFixed(2)}
            </div>
            <div style={{
              fontFamily: "'Courier New', monospace",
              fontSize: '12px',
              ...
              <span>Range: ${etfPriceData.priceRange.min.toFixed(2)} - ${etfPriceData.priceRange.max.toFixed(2)}</span>
              <span style={{ marginLeft: '15px' }}>Total Value: ${etfPriceData.totalValue.toFixed(2)}</span>
            </div>
            <div style={{
              fontFamily: "'Courier New', monospace",
              fontSize: '12px',
              ...
              <span>P&L: ${etfPriceData.totalGainLoss.toFixed(2)} ({etfPriceData.averageGainLossPercent.toFixed(2)}%)</span>
            </div>
          </div>
        </div>
      )}
