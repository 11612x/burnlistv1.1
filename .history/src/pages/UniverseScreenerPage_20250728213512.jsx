      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "20px" }}>
        ...
        {editMode && (
          <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
            <span style={{ color: CRT_GREEN, fontSize: "12px", fontFamily: "'Courier New', monospace" }}>
              MASS SET:
            </span>
            {Object.keys(SETUP_CONFIGS).map(tradeType => (
              <button
                key={tradeType}
                onClick={() => handleMassQuickTradeTypeChange(tradeType)}
                ...
                title={`Set ${selectedRows.size} selected stocks to ${SETUP_CONFIGS[tradeType].name}`}
              >
                {tradeType.charAt(0).toUpperCase() + tradeType.slice(1).replace(/([A-Z])/g, ' $1')}
              </button>
            ))}
          </div>
        )}
    ...
    >
      ...
      <table style={{
        ...
        />
             ...
             <th style={{ width: "7.14%", padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>
               Trade Type
             </th>
             <th style={{ width: "7.14%", padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>
               Quick Type
             ...
             <th style={{ width: "7.14%", padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>SETUP</th>
             <th style={{ width: "7.14%", padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>NEWS</th>
             <th style={{ width: "7.14%", padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>VERDICT</th>
             ...
             <th style={{ width: "7.14%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>SL</th>
             <th style={{ width: "7.14%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>TP</th>
             <th style={{ width: "7.14%", padding: "8px", textAlign: "right", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>Position</th>
             <th style={{ width: "7.14%", padding: "8px", textAlign: "left", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>Notes</th>
          ...
          />
              ...
              <td style={{ width: "7.14%", padding: "8px", textAlign: "left" }}>{item.symbol}</td>
              <td 
              ...
              >
                {editMode ? (
                  ...
                  <span style={{ color: CRT_GREEN, fontFamily: "'Courier New', monospace", fontSize: 14 }}>
                    {item.notes || '-'}
                  </span>
                )}
              </td>
