                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2px', alignItems: 'center' }}>
                  {Object.keys(SETUP_CONFIGS).map(tradeType => (
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handleQuickTradeTypeChange(item.id, item.quickTradeType === tradeType ? "" : tradeType);
                      }}
                      style={{
                        background: item.quickTradeType === tradeType ? CRT_GREEN : 'transparent',
                        color: item.quickTradeType === tradeType ? '#000000' : CRT_GREEN,
                        border: `1px solid ${CRT_GREEN}`,
                        padding: '2px 4px',
                        fontFamily: 'Courier New',
                        fontSize: 10,
                      ...
                      title={SETUP_CONFIGS[tradeType].name}
                    >
