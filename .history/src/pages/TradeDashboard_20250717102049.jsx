...
function TradingViewChart() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      "autosize": true,
      "overrides": {
        "mainSeriesProperties.candleStyle.upColor": "#0de309",
        "mainSeriesProperties.candleStyle.downColor": "#e31507",
        "mainSeriesProperties.candleStyle.borderUpColor": "#0de309",
        "mainSeriesProperties.candleStyle.borderDownColor": "#e31507",
        "mainSeriesProperties.candleStyle.wickUpColor": "#0de309",
        "mainSeriesProperties.candleStyle.wickDownColor": "#e31507"
      }
    });
    if (containerRef.current) {
