  ...
  return (
    <div style={{
          ...
          if (timestamps.length > 0) {
            ...
            if (diffHours < 1) lastUpdate = 'Just now';
              ...
              <div style={{
                ...
                overflow: 'hidden',
                '@media (max-width: 768px)': {
                  height: editMode ? 180 : (view === 'graph' ? 160 : 80),
                  padding: '6px 4px',
                },
                '@media (max-width: 480px)': {
                  height: editMode ? 150 : (view === 'graph' ? 130 : 70),
                  padding: '4px 3px',
                }
              }}>
            {/* Name (editable) */}
      ...
      <div style={{
        ...
        zIndex: 1000,
        '@media (max-width: 768px)': {
          position: 'static', // Move to normal flow on mobile
          marginTop: '20px',
          marginBottom: '100px', // Add space for bottom nav
          justifyContent: 'center',
          gap: '8px',
        },
        '@media (max-width: 480px)': {
          position: 'static',
          marginTop: '16px',
          marginBottom: '90px', // Add space for bottom nav
          justifyContent: 'center',
          gap: '6px',
        }
      }}>
