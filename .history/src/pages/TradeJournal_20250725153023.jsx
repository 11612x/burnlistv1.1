          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{
              ...
              <tbody>
                   ...
                   >
                                                                  <td style={{ padding: '8px', borderRight: `1px solid ${CRT_GREEN}`, fontWeight: 'bold', height: '40px', minHeight: '40px', maxHeight: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                         {trade.ticker}
                       </td>
                       <td style={{ padding: '8px', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', minHeight: '40px', maxHeight: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                       ...
                       <td style={{ padding: '8px', textAlign: 'center', height: '40px', minHeight: '40px', maxHeight: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                         <CustomButton
