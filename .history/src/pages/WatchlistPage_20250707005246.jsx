import { calculatePortfolioReturns } from "./utils/portfolioReturns.js";
...
import useTimeframedReturn from "./utils/useTimeframedReturn";
import WatchlistHeader from "./components/WatchlistHeader";
import TimeframeSelector from "./components/TimeframeSelector";
import TickerRow from "./components/TickerRow";
import TickerTable from "./components/TickerTable";
import { useParams, Link } from "react-router-dom";
import { fetchQuote } from "./finhub";
import WatchlistChart from "./components/WatchlistChart";
import AddTickerInput from "./components/AddTickerInput";
import { mockWatchlist, mockHistoricalData } from "./utils/mockWatchlistData"; //mock data for testing in utils

// Toggle to control whether to use mock data or live/localStorage data
const useMock = true; // flip to false for real/localStorage watchlists
...
/*
  ...
  */
  ...
  useEffect(() => {
    ...
    if (useMock) {
      const filteredMockList = mockWatchlist.filter(item => !removedSymbols.includes(item.symbol));
    ...
    return (
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", marginBottom: 20 }}>
          ...
          <span style={{ marginLeft: 10, color: "#0de309", fontSize: "1.2rem" }}>
            Watchlist empty or not found
          </span>
        </div>
        <WatchlistHeader
          name={"Untitled"}
  ...
  const portfolioReturnData = React.useMemo(() => {
    return calculatePortfolioReturns(filteredSnapshots, timeframe);
  ...
  return (
    ...
    >
      <BackHomeButton top="1rem" left="2rem" />
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      <div style={{ border: "0px solid #0de309", padding: 10, marginBottom: 30 }}>
        ...
        <WatchlistChart portfolioReturnData={portfolioReturnData} showBacktestLine={true} />
      </div>
