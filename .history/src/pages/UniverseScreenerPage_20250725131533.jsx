...
const UniverseScreenerPage = () => {
  ...
  }, [selectedTradeType, journalPanelOpen, checklistItems]);
      ...
      <table style={{
        ...
        />
          ...
          />
                ...
                {editMode ? (
                  ...
                  <span style={{ fontSize: 12 }}>
                    {item.tradeTypeName || '-'}
                            ...
                            <td style={{ width: "7.69%", padding: "8px", textAlign: "right" }}>${item.lastPrice.toFixed(2)}</td>
              ...
              <td style={{ width: "7.69%", padding: "8px", textAlign: "left" }}>
                {editMode ? (
              ...
              <td style={{ width: "7.69%", padding: "8px", textAlign: "center" }}>
                <button
                  ...
                  style={{
                    background: (!item.tradeType || !item.entryPrice || !item.stopLoss || !item.target) ? '#333' : CRT_GREEN,
                    color: (!item.tradeType || !item.entryPrice || !item.stopLoss || !item.target) ? '#666' : 'black',
                    border: `1px solid ${CRT_GREEN}`,
                    borderRadius: 0,
                    padding: '4px 8px',
                    fontFamily: "'Courier New', monospace",
