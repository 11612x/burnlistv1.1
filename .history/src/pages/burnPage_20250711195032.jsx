...
import ImportWatchlistData from "@components/ImportWatchlistData";
...
const BurnPage = () => {
  ...
  useEffect(() => {
    // When component mounts (user navigates to this watchlist)
    // Resume any paused fetch for this watchlist
