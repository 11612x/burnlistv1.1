          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{
              ...
              <tbody>
                   ...
                   >
                     <td style={{ padding: '8px', borderRight: `1px solid ${CRT_GREEN}`, fontWeight: 'bold', height: '40px' }}>
                       {trade.ticker}
                     </td>
                     <td style={{ padding: '8px', borderRight: `1px solid ${CRT_GREEN}`, height: '40px' }}>
                       {trade.setup || trade.setupType || 'Manual'}
                     </td>
                     <td style={{ padding: '8px', textAlign: 'center', borderRight: `1px solid ${CRT_GREEN}`, height: '40px' }}>
                     ...
                     <td style={{ padding: '8px', textAlign: 'center', height: '40px' }}>
                       <CustomButton
