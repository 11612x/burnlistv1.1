    ...
    >
      {editMode ? 'Done' : 'Edit'}
        ...
        />
                 ...
                 <th style={{ padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black' }}>EMA</th>
                 <th style={{ padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black' }}>SMA</th>
                 <th style={{ padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black' }}>RSI</th>
                 <th style={{ padding: "8px", textAlign: "center", borderBottom: `1px solid ${CRT_GREEN}`, background: 'black' }}>NEWS</th>
          ...
          />
                  ...
                  <td style={{ padding: "8px", textAlign: "center" }}>
                    <img src={item.flags.ema ? greenFlag : redFlag} alt="EMA" title="EMA" style={{ width: 16, height: 16, verticalAlign: 'middle', filter: 'drop-shadow(0 0 1px #222)' }} />
                  </td>
                  <td style={{ padding: "8px", textAlign: "center" }}>
                    <img src={item.flags.sma ? greenFlag : redFlag} alt="SMA" title="SMA" style={{ width: 16, height: 16, verticalAlign: 'middle', filter: 'drop-shadow(0 0 1px #222)' }} />
                  </td>
                  <td style={{ padding: "8px", textAlign: "center" }}>
                    <img src={item.flags.rsi ? greenFlag : redFlag} alt="RSI" title="RSI" style={{ width: 16, height: 16, verticalAlign: 'middle', filter: 'drop-shadow(0 0 1px #222)' }} />
                  </td>
                  <td style={{ padding: "8px", textAlign: "center" }}>
                    <img src={item.flags.news ? greenFlag : redFlag} alt="NEWS" title="NEWS" style={{ width: 16, height: 16, verticalAlign: 'middle', filter: 'drop-shadow(0 0 1px #222)' }} />
                  </td>
                  {(() => {
                    const metrics = {
                      epsGrowth: item.epsGrowth || 0,
