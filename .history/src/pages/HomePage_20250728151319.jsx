...
import WatchlistBlocksSection from '@components/WatchlistBlocksSection';
import ScreenerWindowsManager from '@components/ScreenerWindowsManager';
...
const HomePage = ({ watchlists = {}, setWatchlists }) => {
  ...
  return (
    <div style={{
      ...
      {/* Watchlist Blocks Section */}
      <WatchlistBlocksSection />

      {/* Screener Windows Manager */}
      <div style={{
        position: 'fixed',
        bottom: '20px',
        left: '20px',
        ...
        <CustomButton
          onClick={() => {
            const manager = document.querySelector('[data-screener-manager]');
            if (manager) {
      ...
      <div data-screener-manager>
        <ScreenerWindowsManager />
      </div>
