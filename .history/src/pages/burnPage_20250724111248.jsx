...
const BurnPage = () => {
  ...
  // Debug: Log when averageReturn or selectedTimeframe changes
  useEffect(() => {
    console.log('🔍 burnPage: averageReturn changed to:', averageReturn, 'for timeframe:', selectedTimeframe);
  }, [averageReturn, selectedTimeframe]);
