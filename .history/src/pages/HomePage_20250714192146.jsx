...
const HomePage = ({ watchlists = {}, setWatchlists }) => {
  ...
  return (
    <div style={{
      ...
      color: isInverted ? black : green,
      backgroundColor: isInverted ? green : black,
      minHeight: '100vh',
      padding: '32px',
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          >
            <img src={logo} alt="Burnlist Logo" style={{ width: 40, height: 40, marginRight: 10 }} />
          </button>
          <strong style={{ fontSize: '170%', lineHeight: '40px', display: 'inline-block', color: isInverted ? black : green }}>BURNLIST v1.1</strong>
        </div>
