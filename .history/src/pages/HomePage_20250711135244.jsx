    ...
    <div style={{ fontFamily: 'Courier New', color: CRT_GREEN, backgroundColor: 'black', minHeight: '100vh', padding: '32px' }}>
      ...
      {Object.values(watchlists).map((item, idx, arr) => {
        ...
        const cardContent = (
          <div style={{
            width: 252,
            height: editMode ? 216 : (view === 'graph' ? 168 : 120),
            fontFamily: 'Courier New',
            ...
            {view === 'graph' && (
              <div style={{ width: 100, height: 800, alignSelf: 'flex-end', border: `1.5px solid ${CRT_GREEN}`, borderRadius: 0, background: '#101818', padding: 1, marginTop: 2 }}>
                {tickers.length > 0 ? (
                  <WatchlistChart 
