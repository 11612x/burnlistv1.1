    ...
    >
      ...
      <table style={{
        ...
        />
             ...
             <th style={{ width: 32, padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>SETUP</th>
             <th style={{ width: 32, padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>NEWS</th>
             <th style={{ width: 32, padding: '2px 4px', textAlign: 'center', borderBottom: `1px solid ${CRT_GREEN}`, background: 'black', fontSize: 15 }}>VERDICT</th>
