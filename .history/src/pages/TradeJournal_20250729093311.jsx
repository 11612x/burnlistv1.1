...
const TradeJournal = () => {
  ...
  const calculateTradeStats = () => {
    ...
    // Calculate average return (simplified - could be enhanced with actual P&L data)
    const totalReturn = completedTrades.reduce((sum, trade) => {
      if (trade.outcome === 'Win') return sum + 1;
      if (trade.outcome === 'Loss') return sum - 1;
      return sum;
    }, 0);
    const averageReturn = completedTrades.length > 0 ? (totalReturn / completedTrades.length) * 100 : 0;
      ...
      {stats.totalTrades > 0 && (
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ color: '#0de309', fontSize: '18px', fontWeight: 'bold' }}>
              {stats.winTrades}
            </div>
          </div>
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ color: '#e31507', fontSize: '18px', fontWeight: 'bold' }}>
              {stats.lossTrades}
            </div>
          </div>
          <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ 
              color: stats.winRate >= 50 ? '#0de309' : '#e31507', 
              fontSize: '18px', 
              fontWeight: 'bold' 
            }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ 
              color: stats.averageReturn >= 0 ? '#0de309' : '#e31507', 
              fontSize: '18px', 
              fontWeight: 'bold' 
            }}>
