            ...
            <table style={{
              ...
              tableLayout: 'fixed'
                ...
                <tr style={{ 
                  ...
                  <th style={{ padding: '8px', textAlign: 'left', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                    Ticker
                  </th>
                  <th style={{ padding: '8px', textAlign: 'left', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                    Setup
                  </th>
                  <th style={{ padding: '8px', textAlign: 'center', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                    R:R
                  </th>
                  <th style={{ padding: '8px', textAlign: 'center', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                    Verdict
                  ...
                  <th style={{ padding: '8px', textAlign: 'center', height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody>
                   ...
                   >
                                           <td style={{ padding: '8px', borderRight: `1px solid ${CRT_GREEN}`, fontWeight: 'bold', height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                        {trade.ticker}
                      </td>
                      <td style={{ padding: '8px', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                        {trade.setup || trade.setupType || 'Manual'}
                      </td>
                      <td style={{ padding: '8px', textAlign: 'center', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                      ...
                      <td style={{ padding: '8px', textAlign: 'center', height: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle' }}>
                        <CustomButton
