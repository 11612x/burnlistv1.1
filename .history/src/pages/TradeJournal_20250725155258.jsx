            ...
            <table style={{
              ...
              lineHeight: '24px'
                ...
                <tr style={{ 
                  ...
                  <th style={{ padding: '0px', textAlign: 'left', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', minHeight: '40px', maxHeight: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle', overflow: 'hidden' }}>
                    Ticker
                  </th>
                  <th style={{ padding: '0px', textAlign: 'left', borderRight: `1px solid ${CRT_GREEN}`, height: '40px', minHeight: '40px', maxHeight: '40px', lineHeight: '24px', boxSizing: 'border-box', verticalAlign: 'middle', overflow: 'hidden' }}>
                    Setup
