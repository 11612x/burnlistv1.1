    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 32 }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          {/* Watchlist Table (shows when selected) */}
          {watchlistData && Array.isArray(watchlistData.items) && watchlistData.items.length > 0 && (
            <div style={{ ...boxStyle, minHeight: 120 }}>
              <div style={{ fontWeight: 700, fontSize: 16, marginBottom: 8 }}>Watchlist Stocks</div>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 15 }}>
                <thead>
                  <tr style={{ borderBottom: `1.5px solid ${CRT_GREEN}` }}>
                    <th style={{ textAlign: 'left', padding: 6 }}>Symbol</th>
                    <th style={{ textAlign: 'right', padding: 6 }}>Latest</th>
