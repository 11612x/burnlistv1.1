  ...
  return (
    <div style={{ backgroundColor: isInverted ? 'rgb(140,185,162)' : 'transparent', minHeight: '100vh', color: isInverted ? '#000000' : '#ffffff', padding: '20px' }}>
            ...
            boxShadow: `0 2px 16px 0 rgba(140,185,162,0.08)`
               ...
               {sortedUniverse.map((item, idx) => (
                ...
                >
                  ...
                  <td style={{ padding: "8px", textAlign: "left", display: 'flex', alignItems: 'center', gap: 8 }}>
                    {item.symbol}
                    <button
      ...
      <div style={{
        ...
        <h4 style={{ color: CRT_GREEN, fontFamily: "'Courier New', monospace", margin: '0 0 8px 0', fontSize: 17, fontWeight: 700 }}>
          Bulk Add Tickers
        </h4>
        <div style={{ display: 'flex', gap: '8px', alignItems: 'flex-end' }}>
          ...
          <button
            ...
            style={{
              background: isLoading ? '#222' : CRT_GREEN,
