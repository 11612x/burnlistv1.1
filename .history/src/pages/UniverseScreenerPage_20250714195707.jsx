               ...
               {sortedUniverse.map((item) => (
                <tr key={item.id} style={{ borderBottom: `1px solid ${CRT_GREEN}` }}>
                  ...
                  {editMode && (
                    <>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.epsGrowth || ''} onChange={e => handleItemChange(item.id, 'epsGrowth', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.avgVolume || ''} onChange={e => handleItemChange(item.id, 'avgVolume', e.target.value)} style={{ width: 90, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.relVolume || ''} onChange={e => handleItemChange(item.id, 'relVolume', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.earningsDaysAway || ''} onChange={e => handleItemChange(item.id, 'earningsDaysAway', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.pe || ''} onChange={e => handleItemChange(item.id, 'pe', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.marketCap || ''} onChange={e => handleItemChange(item.id, 'marketCap', e.target.value)} style={{ width: 110, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.debtEquity || ''} onChange={e => handleItemChange(item.id, 'debtEquity', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.pb || ''} onChange={e => handleItemChange(item.id, 'pb', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "right" }}>
                        <input type="number" value={item.beta || ''} onChange={e => handleItemChange(item.id, 'beta', e.target.value)} style={{ width: 70, background: 'black', color: CRT_GREEN, border: 'none', fontFamily: "'Courier New', monospace" }} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "center" }}>
                        <input type="checkbox" checked={item.sectorAlignment || false} onChange={e => handleItemChange(item.id, 'sectorAlignment', e.target.checked)} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "center" }}>
                        <input type="checkbox" checked={item.marketSupport || false} onChange={e => handleItemChange(item.id, 'marketSupport', e.target.checked)} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "center" }}>
                        <input type="checkbox" checked={item.volatilityClear || false} onChange={e => handleItemChange(item.id, 'volatilityClear', e.target.checked)} />
                      </td>
                      <td style={{ padding: "8px", textAlign: "center" }}>
                        <input type="checkbox" checked={item.breadthHealthy || false} onChange={e => handleItemChange(item.id, 'breadthHealthy', e.target.checked)} />
                      </td>
                    </>
                  )}
                  <td style={{ padding: "8px", textAlign: "right" }}>
