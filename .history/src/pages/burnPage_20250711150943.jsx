  ...
  return (
    <div style={{ backgroundColor: "transparent", minHeight: "100vh", color: "#ffffff" }}>
      ...
      <div style={{ padding: "20px 20px 0 20px", marginBottom: "100px" }}>
        ...
        <button onClick={handleManualRefresh} style={{ marginTop: 10, background: '#222', color: '#8CB9A2', border: '1px solid #8CB9A2', padding: '6px 16px', fontFamily: 'Courier New', cursor: 'pointer' }}>
          Refresh
        </button>
      </div>
