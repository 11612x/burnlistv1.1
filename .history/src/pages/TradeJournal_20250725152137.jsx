...
const TradeJournal = () => {
  ...
  const getVerdict = () => {
    // Since we removed setup selection, always return qualified
    return { type: "qualified", text: "Qualified", flag: greenflag };
  };
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '30px' }}>
        <h2 style={{ marginBottom: '15px', fontSize: '18px' }}>1. ENTRY DETAILS</h2>
          <div style={{ 
            display: 'grid', 
      ...
      {/* Risk Management */}
      <div style={{ marginBottom: '30px' }}>
        <h2 style={{ marginBottom: '15px', fontSize: '18px' }}>2. RISK MANAGEMENT</h2>
          <div style={{ 
            display: 'grid', 
            gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', 
            gap: '15px' 
      ...
      {verdict && (
        <div style={{ marginBottom: '30px' }}>
          <h2 style={{ marginBottom: '15px', fontSize: '18px' }}>3. SETUP VERDICT</h2>
          <div style={{
            padding: '15px',
