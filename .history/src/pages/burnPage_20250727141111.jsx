      ...
      {etfPriceData && etfPriceData.averagePrice > 0 && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ color: '#888' }}>
              Range: ${etfPriceData.priceRange.min.toFixed(2)} - ${etfPriceData.priceRange.max.toFixed(2)}
            </div>
            <div style={{ color: '#888' }}>
              {returnPercent !== null ? `${returnPercent.toFixed(2)}%` : "–%"} ({selectedTimeframe?.toUpperCase() || "N/A"})
            </div>
            <div style={{ 
