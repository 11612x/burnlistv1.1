      ...
      {selectedSetup && (
        <div style={{ marginBottom: '30px' }}>
              ...
              <label key={index} style={{ 
                ...
                >
                  <img
                    ...
                    style={{ width: 22, height: 22, marginRight: 6, filter: isInverted ? 'invert(1)' : 'none' }}
                  />
                </span>
          ...
          <div style={{ marginTop: 24 }}>
            <h3 style={{ marginBottom: '10px', fontSize: '16px', color: CRT_GREEN }}>News Validation</h3>
            <div style={{ 
              display: 'grid', 
              gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', 
              gap: '10px',
              ...
              {SETUP_CONFIGS[selectedSetup].newsValidation.map((item, index) => (
                <label key={index} style={{ 
                  display: 'flex', 
                  alignItems: 'center', 
                  gap: '10px',
