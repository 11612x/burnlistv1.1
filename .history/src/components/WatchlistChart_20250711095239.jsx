...
const WatchlistChart = ({ portfolioReturnData, showBacktestLine, height = 300, lineColor = '#7FBAA1', hideAxes = false, hideBorder = false, showTooltip = true }) => {
  ...
  return (
    <div style={{ width: "100%", height: height, padding: 0, margin: 0, border: hideBorder ? 'none' : '2px solid #7FBAA1', boxSizing: 'border-box', backgroundColor: '#000', fontFamily: 'Courier New' }}>
