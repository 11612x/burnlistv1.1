...
const WatchlistChart = ({ portfolioReturnData, showBacktestLine, height = 300 }) => {
  ...
  return (
    <div style={{ width: "100%", height: height, padding: 0, margin: 0, border: '2px solid #0de309', boxSizing: 'border-box', backgroundColor: '#000000' }}>
