      ...
      <div style={{
        ...
        <div>
          <a href="/" style={{
            ...
            <img src={backButton} alt="back" style={{ width: 22, height: 22, marginRight: 6, filter: isInverted ? 'invert(1)' : 'none' }} />
            <span style={{ fontFamily: 'Courier New', color: green, fontWeight: 400, fontSize: '1rem', letterSpacing: 1, textTransform: 'lowercase' }}>back</span>
          </a>
        </div>
