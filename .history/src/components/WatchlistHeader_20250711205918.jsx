    ...
    >
      ...
      <div style={{
        ...
        <div style={{ textAlign: "right", paddingRight: "3.5rem", maxWidth: "60%" }}>
          ...
          {/* API Request Status - only show when fetch is active for this watchlist */}
          ...
          {/* Show Y/Y when not actively fetching this watchlist */}
          {!fetchProgress && realStockCount > 0 && (
            <div 
              style={{ 
                marginTop: "0.5rem", 
                fontSize: "0.8rem", 
            ...
            >
              {realStockCount}/{realStockCount} (100%)
            </div>
          )}
