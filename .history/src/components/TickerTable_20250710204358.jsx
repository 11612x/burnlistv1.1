    ...
    <table style={{ width: "100%", borderCollapse: "collapse", color: "#0de309" }}>
      <thead>
        <tr>
          ...
          <th onClick={() => handleSort("symbol")} style={{ cursor: "pointer", padding: 8, textAlign: "left", color: "#0de309" }}>
            Symbol {renderSortArrow("symbol")}
          </th>
          <th onClick={() => handleSort("buyPrice")} style={{ cursor: "pointer", padding: 8, textAlign: "left", color: "#0de309" }}>
            Buy Price {renderSortArrow("buyPrice")}
          </th>
          <th onClick={() => handleSort("currentPrice")} style={{ cursor: "pointer", padding: 8, textAlign: "left", color: "#0de309" }}>
            Current Price {renderSortArrow("currentPrice")}
          </th>
          <th onClick={() => handleSort("changePercent")} style={{ cursor: "pointer", padding: 8, textAlign: "left", color: "#0de309" }}>
            Change % {renderSortArrow("changePercent")}
          </th>
          {/* Show Actions column only if edit mode is enabled */}
          {editMode && <th style={{ padding: 8, textAlign: "left", color: "#0de309" }}>Actions</th>}
          <th style={{ textAlign: "left", color: "#0de309" }} />
        </tr>
      </thead>
      <tbody>
