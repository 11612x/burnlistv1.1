...
const TickerRow = ({
  ...
  console.log(`💰 [Row Debug] ${item.symbol}:`);
  console.log(`  - lookedUpBuyPrice: ${lookedUpBuyPrice}`);
  console.log(`  - item.buyPrice: ${item.buyPrice}`);
  console.log(`  - Final buy price used: ${buy}`);
