...
// Global request counter to track API calls (for rate limiting)
...
function incrementGlobalRequestCounter() {
  resetGlobalRequestCounter();
  globalRequestCount++;
  console.log(`📊 Global API Request #${globalRequestCount}/60 (resets in ${Math.ceil((60000 - (Date.now() - lastResetTime)) / 1000)}s)`);
}
...
export class FetchManager {
  ...
  getRequestStatus() {
    ...
    return {
      ...
      limit: 60,
      remaining: 60 - globalRequestCount,
