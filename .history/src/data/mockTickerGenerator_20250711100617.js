    ...
    items: [
      {
        ...
        historicalData: makeVolatileHistory(100, [8, -10, 12, -15, 7, -8], 30, now),
      },
      {
        symbol: 'MOCK2',
        buyDate: new Date(now).toISOString(),
        historicalData: makeVolatileHistory(50, [5, -7, 9, -11, 6, -6], 30, now),
      },
      {
        symbol: 'MOCK3',
        buyDate: new Date(now).toISOString(),
        historicalData: makeVolatileHistory(200, [15, -20, 18, -22, 10, -12], 30, now),
      },
      {
        symbol: 'MOCK4',
        buyDate: new Date(now).toISOString(),
        historicalData: makeVolatileHistory(80, [10, -13, 11, -14, 8, -9], 30, now),
      },
    ],
