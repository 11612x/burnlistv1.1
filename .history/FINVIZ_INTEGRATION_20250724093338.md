...
**Important**: The system now uses the **complete historical data** from the CSV file, not just the current price. This provides much more comprehensive data for charts and analysis.
...
- **Comparison**: Shows difference between your buy price and current market price

### **Buy Price Logic:**
1. If you enter a custom buy price → Uses your price
2. If no custom price → Uses current market price as buy price
3. Shows return calculation: (Current Price - Buy Price) / Buy Price

### **Buy Date Logic:**
1. If you enter a custom buy date → Uses your date
2. If no custom date → Uses current market date as buy date
3. Shows time period since your buy date
